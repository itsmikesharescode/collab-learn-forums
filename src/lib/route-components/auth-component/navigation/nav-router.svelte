		...
		<Sheet.Header class="mt-[30px] flex flex-col gap-[20px]">
			...
			<div class="">
				...
				<Sheet.Description class="max-h-[100px] overflow-auto text-left">
					...
					maxime aperiam magnam sapiente cum pariatur veritatis, dolorem culpa nemo eos et voluptas
					nesciunt, maiores fuga adipisci optio autem quis sed? Sit atque natus suscipit quod
					quaerat saepe iure voluptates commodi dicta sint dolorem sequi at consectetur maiores ea,
					officia incidunt delectus necessitatibus voluptate harum quae tempora consequatur
					quisquam? Sequi ipsa quae ipsum voluptatem ullam rem officia sunt qui, odio perspiciatis
					velit quo dolor amet natus, tenetur provident modi impedit laudantium veritatis.
					Blanditiis facilis in, sunt minima commodi quia tempora consectetur aliquam laudantium
					incidunt optio perferendis illo aperiam. Animi!
				</Sheet.Description>
			</div>
